...
const Subscribe = () => {
  return (
    <div className='w-[94vw] p-10 bg-[#dbdbdb]'>
        <div className='my-20 text-white flex flex-col items-center justify-center py-5 bg-black'>
            ...
            className='w-fit relative border mt-5 overflow-hidden hover:text-black '>
